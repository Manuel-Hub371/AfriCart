        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto w-full space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-4 rounded-xl border border-gray-200/80 shadow-2xs">
            <div>
              ...
              <p className="text-xs text-gray-500 font-medium mt-0.5">
                Manage your personal profile details, notification preferences, and region settings
              </p>
            </div>
            <Button
              onClick={handleSave}
              disabled={isSaving}
              className="gradient-primary text-white font-bold text-xs h-8 px-4 rounded-lg shadow-2xs gap-1.5 self-start sm:self-auto"
            >
              {isSaving ? (
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl border border-gray-200/80 p-4 sm:p-5 shadow-2xs space-y-3">
              <h2 className="text-sm font-extrabold text-gray-900">Profile Picture</h2>
              <div className="flex items-center gap-4">
                <div className="relative">
                  <Avatar className="h-16 w-16 overflow-hidden border border-gray-200">
                    {avatarUrl ? (
                      <img src={avatarUrl} alt="Avatar" className="w-full h-full object-cover rounded-full" />
                    ) : (
                      <AvatarFallback className="bg-emerald-600 text-white text-lg font-extrabold">
                        {initials}
                      </AvatarFallback>
                    )}
                  </Avatar>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      className="gap-1.5 h-8 text-xs font-bold px-3 rounded-lg border-gray-200"
                    ...
                    {avatarUrl && (
                      <Button
                        ...
                        variant="ghost"
                        size="sm"
                        className="text-red-600 hover:text-red-700 hover:bg-red-50 text-xs h-8 px-2 font-bold"
                  ...
                  <p className="text-[10px] text-gray-400 font-medium">PNG or JPG up to 10 MB</p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <Input
                    ...
                    disabled
                    className="bg-gray-100/70 text-gray-500 cursor-not-allowed h-8 text-xs rounded-lg border-gray-200"
                  />
                </div>
                <div>
                  <label className="block text-[11px] font-bold text-gray-700 uppercase tracking-wider mb-1">
            ...
            {/* Preferences */}
            <div className="bg-white rounded-xl border border-gray-200/80 p-4 sm:p-5 shadow-2xs space-y-3">
              <h2 className="text-sm font-extrabold text-gray-900">Regional Preferences</h2>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[11px] font-bold text-gray-700 uppercase tracking-wider mb-1">
                    Language
            ...
            <div className="bg-white rounded-xl border border-gray-200/80 p-4 sm:p-5 shadow-2xs space-y-3">
              ...
              <div className="space-y-3">
                ...
                <label className="flex items-center justify-between cursor-pointer pt-2 border-t border-gray-100">
                  <div>
                    <h3 className="font-bold text-xs text-gray-900">Order Status Updates</h3>
                    <p className="text-[11px] text-gray-400 font-medium">
                      Real-time notifications about your shipment statuses
                    </p>
                  </div>
                  <input
                    type="checkbox"
            ...
            <div className="flex justify-end pt-2">
              <Button
                onClick={handleSave}
                disabled={isSaving}
                className="gradient-primary text-white font-bold text-xs h-8 px-5 rounded-lg shadow-2xs gap-1.5 w-full sm:w-auto"
              >
                {isSaving ? (
                  <Loader2 className="h-3.5 w-3.5 animate-spin" />
                ) : (
