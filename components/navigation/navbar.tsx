...
import { Search, ShoppingCart, Bell, User, Heart, Package, Store, Tag } from "lucide-react";
        ...
        <div className="flex items-center justify-between h-14 md:h-16 gap-2">
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            {isAuthenticated ? (
              ...
              <Link
                href="/auth/login"
                className="hidden md:inline-flex px-3 py-1.5 text-xs font-bold text-emerald-700 hover:text-emerald-800 bg-emerald-50 rounded-lg transition-colors"
              >
                Login
              </Link>
            )}
