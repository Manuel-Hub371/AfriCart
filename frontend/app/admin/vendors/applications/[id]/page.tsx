...
import { VendorApplicationDetailDTO } from "@/shared/types/admin";
...
export default function VendorApplicationDetailPage({
  ...
  const fetchDetail = async () => {
    try {
      setLoading(true);
      setError(null);
      const res = await apiFetch(`/api/admin/vendors/applications/${storeId}`);
      if (!res.ok) {
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      const res = await apiFetch(`/api/admin/vendors/${storeId}/approve`, {
        method: "PATCH",
      });
  ...
  const handleReactivate = async () => {
    ...
    try {
      ...
      const res = await apiFetch(`/api/admin/vendors/${storeId}/reactivate`, {
        method: "PATCH",
      });
