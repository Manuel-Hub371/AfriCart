              ...
              >
                ...
                <TableCell>
                  <div className="flex flex-col">
                    {product.isDiscounted && product.effectivePrice != null ? (
                      <>
                        <span className="font-extrabold text-emerald-700">GH₵{product.effectivePrice.toFixed(2)}</span>
                        <span className="text-xs text-gray-400 line-through">GH₵{product.price.toFixed(2)}</span>
                      </>
                    ) : (
                ...
                <TableCell>
                  {product.campaignName ? (
                    <span className="inline-flex items-center gap-1 text-xs font-bold px-2.5 py-1 rounded-full bg-red-100 text-red-700 border border-red-200 max-w-[120px] truncate" title={product.campaignName}>
                      🏷 {product.campaignName}
